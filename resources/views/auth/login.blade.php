<x-guest-layout>
    ...
    @session('error')
    <div x-data="{ isOpen: true }" x-show="isOpen" x-cloak class="relative flex flex-col sm:flex-row sm:items-center bg-red-300 dark:bg-red-700 shadow rounded-md py-5 pl-6 pr-8 sm_pr-6 mb-3 mt-3">
        <div class="flex flex-row items-center border-b sm:border-b-0 w-full sm:w-auto pb-4 sm:pb-0">
            ...
            <div class="text-sm font-medium ml3 dark:text-gray-100">Error!.</div>
        </div>
